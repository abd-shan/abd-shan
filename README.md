...
| :--- | :--- | :--- | :---: |
| **Easy Apply System** | A secure, dynamic portal for high-volume applications. Implemented a data-driven UI where all content is dynamically fetched and rendered based on admin configurations. **No VPN , syrian ip only** | Next.js, Redux, Tailwind , Framer Motion, next-intl| [🔗 Live](https://apply.alfateh.cloudtech-it.com:8443/) |
